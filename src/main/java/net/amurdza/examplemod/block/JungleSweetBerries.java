...
public class JungleSweetBerries extends SweetBerryBushBlock {
    public JungleSweetBerries(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit) {
        ...
        if (!flag && pPlayer.getItemInHand(pHand).is(Items.BONE_MEAL)) {
            ...
            popResource(pLevel, pPos, new ItemStack(ModItems.JUNGLE_SWEET_BERRIES.get(), count));
    ...
    public ItemStack getCloneItemStack(BlockGetter pLevel, BlockPos pPos, BlockState pState) {
        return new ItemStack(ModItems.JUNGLE_SWEET_BERRIES.get());
    }
}
