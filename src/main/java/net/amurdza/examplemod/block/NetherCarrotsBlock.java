...
public class NetherCarrotsBlock extends NetherCropBlock{
    ...
    public NetherCarrotsBlock(BlockBehaviour.Properties pProperties) {
        super(pProperties);
    }

    protected ItemLike getBaseSeedId() {
        return ModItems.WARPED_CARROT.get();
    }
