...
public class NetherPotatoBlock extends NetherCropBlock{
    ...
    public NetherPotatoBlock(BlockBehaviour.Properties pProperties) {
        super(pProperties);
    }

    protected ItemLike getBaseSeedId() {
        return ModItems.CRIMSON_POTATO.get();
    }
